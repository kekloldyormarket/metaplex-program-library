...
export const MPL_UPDATE_METADATA_PROGRAM_ID = new PublicKey(
...
export function mplUpdateMetadataProgram(params?: GetProgramParams): Program<MplUpdateMetadata> {
  return new Program<MplUpdateMetadata>(
    IDL,
    params?.programId ?? MPL_UPDATE_METADATA_PROGRAM_ID,
    params?.provider,
    new MplUpdateMetadataCoder(IDL),
  );
}

type MplUpdateMetadata = {
  version: '0.3.0';
