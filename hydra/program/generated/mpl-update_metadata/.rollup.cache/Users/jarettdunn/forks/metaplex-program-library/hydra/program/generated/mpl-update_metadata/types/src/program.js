...
import { MplUpdateMetadataCoder } from './coder';
export const MPL_UPDATE_METADATA_PROGRAM_ID = new PublicKey('5F6oQHdPrQBLdENyhWUAE4mCUN13ZewVxi5yBnZFb9LW');
export function mplUpdateMetadataProgram(params) {
    var _a;
    return new Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : MPL_UPDATE_METADATA_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new MplUpdateMetadataCoder(IDL));
}
const IDL = {
    version: '0.3.0',
